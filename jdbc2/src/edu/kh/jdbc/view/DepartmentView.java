 ...
 */
	private void insertDepartment() throws SQLException {
		...
		System.out.print("부서 명(deptTitle) 입력 : ");
	...
	/*
	 * int result = dao.deleteDepartment(code);
	 * 
	 * if (result == 0) { System.out.println(code + "이 포함된 부서가 없습니다.");
	 * 
	 * } else {
	 * 
	 * System.out.println("\n[해당 부서를 삭제했습니다]\n");
	...
	private void updateDepartment() throws SQLException { // 부서 코드, 변경할 부서명 입력
		System.out.println("\n----- 부서명 변경 -----\n");

		System.out.print("부서 코드 검색 : ");
		String deptId = sc.next();
		...
		int result = dao.updateDepartment(deptTitle, deptId);
